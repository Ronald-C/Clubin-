...
CREATE TABLE `Comment` (
  ...
  PRIMARY KEY (`Article_fk`,`Author_fk`,`Timestamp`),
...
INSERT INTO `MemberOf` VALUES (2,1,'2016-04-06 06:30:23',1);
...
INSERT INTO `OfficerOf` VALUES (2,1,'President',1);
...
INSERT INTO `Organization` VALUES (1,'SCE','Software and Computer Engineering Society','2016-04-06 04:58:06','School of Engineering','294',NULL);
...
CREATE TABLE `OrganizationAdvisor` (
  ...
  PRIMARY KEY (`Organization_fk`,`Advisor_fk`),
...
CREATE TABLE `OrganizationInterest` (
  ...
  PRIMARY KEY (`Organization_fk`,`Interest_fk`),
...
CREATE TABLE `StudentInterest` (
  `Student_fk` int(11) unsigned NOT NULL,
  `Interest_fk` int(11) unsigned NOT NULL,
  PRIMARY KEY (`Student_fk`,`Interest_fk`),
...
CREATE TABLE `TroubleMaker` (
  ...
  KEY `fk_TroubleMaker_3_idx` (`Organization_fk`),
  CONSTRAINT `fk_TroubleMaker_3` FOREIGN KEY (`Organization_fk`) REFERENCES `Organization` (`OrganizationID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `TroubleMaker` VALUES (12,2,1,'2016-04-07 00:15:52');
...
-- Dump completed on 2016-04-06 17:17:31
